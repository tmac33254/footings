    ...
    <main>
      ...
      <section className="blueprint-grid pt-24 pb-16 border-b border-zinc-700/60">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h1 className="mt-5 text-4xl md:text-5xl font-bold tracking-tight animate-fade-up animate-delay-200 max-w-2xl">
          ...
          <div className="space-y-0">
            {articles.map((article, i) => (
              <a
                ...
                className="group block py-10 border-t border-zinc-700/60 hover:bg-zinc-900/40 -mx-6 px-6 lg:-mx-8 lg:px-8"
              >
                <div className="grid grid-cols-1 md:grid-cols-[80px_1fr_auto] gap-6 md:gap-12 items-start">
                  <div className="font-mono text-zinc-600 text-sm font-medium pt-1">
                    {article.label}
                  </div>
                  ...
                  <div>
                    <h2
                      ...
                      className="text-xl font-bold text-zinc-100 tracking-tight group-hover:text-amber-400 leading-snug"
                    >
                      {article.title}
                    </h2>
                    <p className="mt-3 text-zinc-400 leading-relaxed text-[15px] max-w-2xl">
                      {article.description}
                    </p>
                  ...
                  <div className="hidden md:flex items-center">
                    <ArrowRight
                      ...
                      className="text-zinc-700 group-hover:text-amber-500 group-hover:translate-x-1"
                    />
                  </div>
                </div>
              </a>
