    ...
    <section id="problem" className="py-24 border-t border-zinc-700/60">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <AnimateIn>
          ...
          <p className="mt-3 text-zinc-400 max-w-lg leading-relaxed text-[15px]">
        ...
        <div className="mt-16 space-y-0">
          {problems.map((p, i) => (
            <AnimateIn key={p.number} delay={i * 80}>
              <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] gap-8 md:gap-16 py-12 border-t border-zinc-700/60 items-start">
                ...
                <div>
                  ...
                  <div className="mt-3 text-xs text-zinc-500 leading-snug max-w-[200px]">
                    {p.statLabel}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-zinc-300 leading-relaxed text-[15px] max-w-2xl">
                    {p.description}
                  </p>
                </div>
              </div>
