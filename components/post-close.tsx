...
export default function PostClose() {
  return (
    <section id="post-close" className="py-24 border-t border-zinc-200">
          ...
          <AnimateIn>
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-flex items-center gap-2 border border-zinc-300 hover:border-amber-500/60 hover:text-amber-600 text-zinc-700 font-medium text-sm px-6 py-3 active:scale-[0.97]"
              >
              ...
              {inclusions.map((item, i) => {
                ...
                return (
                  <AnimateIn key={i} delay={i * 60}>
                    <div className="flex items-start gap-5 py-5 border-t border-zinc-200">
